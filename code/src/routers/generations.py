...
from db.DB_ops import create_generation, get_all_generations, get_all_observations, get_all_tpms_sensors, get_generation, populate_generation_with_car_observations, populate_generation_with_cars
...
def create_new_generation(payload: CreateGenerationDto):
    ...
    create_car_dtos, create_car_observation_dtos = create_generation_data(unpopulated_generation, tpms_sensors,observations)
